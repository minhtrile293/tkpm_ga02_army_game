...
public class DeathNotifierObserver implements IObserver{
    ...
    public void update(ISoldier deadSoldier) {
        ...
        System.out.printf("[DeathNotifierObserver] Binh lính %s da tu trận.%n", deadSoldier.getName());
        System.out.printf("   -> [Email System] Đang gửi email xin lỗi đến ban be cua %s... Hoan tat.%n", deadSoldier.getName());
    }    
}