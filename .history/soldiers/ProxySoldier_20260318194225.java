...
if (allowedEquipments != null && !allowedEquipments.contains(equipmentClass)) {
            System.out.println("❌ TỪ CHỐI: Trang bị [" + equipmentClass.getSimpleName() + "] không thuộc thế hệ của binh lính này!");
            return;
        }
