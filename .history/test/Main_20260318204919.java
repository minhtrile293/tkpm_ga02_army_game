...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n[DIEN BIEN 4] Tinh hinh tran chien sau 2 dot tan cong...");
        countVisitor = new CountVisitor(); // Reset bo dem
        countVisitor.setCountDead(false); // Chi dem lính còn sống
        alliedArmy.accept(countVisitor);
        System.out.println("-> Quan so chi con lai: " + countVisitor.getTotal() + " chien binh kien cuong.");
        ...
        System.out.println("=> BAU TROI SUP DO! Toan quan ganh chiu: " + damageWave3 + " damage.");
        ...
        if(isSurvive) {
            ...
            System.out.println("TOAN QUAN TU TRAN! Chien dich that bai tham hai...");
        }
    }
}