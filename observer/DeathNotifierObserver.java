...
public class DeathNotifierObserver implements IObserver{
    ...
    public void update(ISoldier deadSoldier) {
        ...
        System.out.printf("[DeathNotifierObserver] Binh linh %s da tu tran.%n", deadSoldier.getName());
        System.out.printf("   -> [Email System] Dang gui email xin loi den ban be cua %s... Hoan tat.%n", deadSoldier.getName());   
    }    
}